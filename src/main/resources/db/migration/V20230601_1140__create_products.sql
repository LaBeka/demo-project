...
insert into products (name, image, description, initial_price, storage_qty, discount, current_price,
                      new_product, brand_id, category_id)
values ('Cutting bar', 'cuttingBar.jpg',
        'The Math.ceil() static method always rounds up and returns the smaller integer greater than or equal to a given number.',
        '110.90', '20', '0', 110.90, 'true', 1, 1),
       ('Small knife', 'smallKnife.jpg',
        ...
        '54.95', '20', '0', 54.95, 'true', 2, 1),
       ('Iva Glass Decorative Bowl', 'ivaGlassDecorativeBowl.jpg',
        ...
        '33.93', '20', '5', 32.23, 'true', 3, 2),
       ('Bowl by Joss & Main', 'bowlJossMain.jpg',
        ...
        '116.85', '20', '30', 81.79, 'true', 4, 2),
       ('Wair Fair basics', 'wairFairbasics.jpg',
        ...
        '79.50', '20', '60', 31.80, 'true', 1, 3),
       ('Silk bamboo tree', 'silkBambooTree.jpg',
